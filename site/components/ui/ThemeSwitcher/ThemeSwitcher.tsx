      ...
      <div className='relative'>
        ...
        <div className='absolute top-0 right-0'>
          {themes.length && display ? (
            <div className='fixed shadow-lg right-0 top-12 mt-2 origin-top-right w-full h-full outline-none bg-accent-0 z-40 lg:absolute lg:border lg:border-accent-1 lg:shadow-lg lg:w-56 lg:h-auto'>
